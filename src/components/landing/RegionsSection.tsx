  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="p-6">
          <h1 className="py-6 text-3xl font-medium leading-none tracking-tighter text-inverted-foreground dark:text-inverted-foreground sm:text-4xl md:text-5xl lg:text-6xl">
            Regions
          </h1>
